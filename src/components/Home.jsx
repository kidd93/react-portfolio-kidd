  ...
  return (
    <div name='home' className='w-full h-screen p-8' style={{ backgroundImage: `url(${bg})`, backgroundRepeat: `no-repeat`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      ...
      <div className='absoulte flex flex-col justify-center items-center w-full h-full text-zinc-300'>
        ...
        <p className='max-w-[1000px] text-lg pb-5'>My Name is Kelsie Kidd. I am a certified Full Stack Web Developer. Please feel free to explore my portfolio.</p>
        <button className='border-2 border-zinc-400 shadow-lg shadow-black group px-5 py-3 hover:bg-sky-900 hover:border-sky-900 font-semibold'>
