...
const Projects = () => {
  return (
    <div className='w-full relative md:h-screen bg-slate-500 text-zinc-300' style={{ backgroundImage: `url(${bg})`, backgroundRepeat: `no-repeat`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }} name='projects'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              <div>
                <a href='https://style-buddy22.herokuapp.com/'>
                  <img src={styleBuddy} alt='' className='project shadow-xl shadow-black hover:shadow-zinc-400'>
                  </img>
                </a>
              </div>
              ...
              <div>
                <a href='https://vast-mountain-00582.herokuapp.com/'>
                  <img src={booksearch} alt='' className='project shadow-xl shadow-black hover:shadow-zinc-400'>
                  </img>
                </a>
              </div>
            </div>
          ...
          <div className='flex flex-col justify-center m-5'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              <div>
                  ...
                  <img src={soon} alt='' className='project shadow-xl shadow-black hover:shadow-zinc-400'>
                  </img>
              ...
              <div>
                <a href='https://alexcourtney18.github.io/cocktail-doggo/'>
                  <img src={Doggypedia} alt='' className='project shadow-xl shadow-black hover:shadow-zinc-400'>
                  </img>
                </a>
              </div>
            </div>
